#!/usr/bin/env python3
# GUI controller adapted for PTZOptics cameras, which speak raw VISCA over a
# plain TCP socket (port 5678) rather than the Sony VISCA-over-IP UDP
# envelope protocol (port 52381) that visca_over_ip/gui.py were written for.
